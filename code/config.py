...
from diffusion.base import GenerativeType, LossType, ModelMeanType, get_named_beta_schedule
from model import *
# from choices import *
...
class TrainConfig(BaseConfig):
    ...
    def _make_diffusion_conf(self, T=None):
        if self.diffusion_type == 'beatgans':
            ...
            # print(id(self.beatgans_model_var_type))
            # print(id(ModelVarType.fixed_large))
